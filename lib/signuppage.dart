            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  _buildTextField(fullNameController, "Ad Soyad", _showErrorName, (value) {
                    setState(() => _showErrorName = value.trim().isEmpty || !RegExp(r'^[a-zA-Z ]+$').hasMatch(value));
                  }),

                  _buildTextField(emailController, "Email", _showErrorEmail || _emailInUse, (value) {
                  ...
                  _buildTextField(confirmPasswordController, "Parola tekrar", _showErrorRePassword, (value) {
